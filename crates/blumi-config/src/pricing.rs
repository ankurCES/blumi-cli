//! Rough cost estimation shared across blumi (dashboard spend analytics,
//! per-task cost, and routing savings math).
//!
...
pub fn estimate(model: &str, input: u64, output: u64) -> f64 {
